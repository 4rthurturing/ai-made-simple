...
export default function TermsPage() {
  return (
    <article className="prose max-w-content mx-auto">
      ...
      <h2 className="text-h2 font-bold mt-10 mb-4" style={{ color: "#2D5A3D" }}>What Sage is</h2>
      <p className="text-body mb-6">
        Sage is a free educational website that helps older adults learn about artificial intelligence. We provide articles, guides, a glossary, and an AI chatbot you can practise with. Everything on Sage is provided free of charge.
      </p>
      ...
      <p className="text-body mb-6">
        Nothing on Sage should be taken as medical, legal, financial, or other professional advice. Our content is educational and general in nature. If you need professional advice, please speak to a qualified professional.
      </p>

      <h2 className="text-h2 font-bold mt-10 mb-4" style={{ color: "#2D5A3D" }}>Accuracy of information</h2>
      <p className="text-body mb-6">
        We do our best to keep everything on Sage accurate and up to date. However, the world of technology changes quickly, and we cannot guarantee that every piece of information is current at all times. If you spot something that looks wrong, please let us know at{" "}
      ...
      <p className="text-body mb-6">
        All content on Sage, including text, images, and design, belongs to us unless stated otherwise. You are welcome to share links to our pages and quote small sections with credit. Please do not copy entire pages or republish our content without permission.
      </p>

      <h2 className="text-h2 font-bold mt-10 mb-4" style={{ color: "#2D5A3D" }}>How you use the site</h2>
      <p className="text-body mb-4">
        When using Sage, please do not:
      </p>
      ...
      <p className="text-body mb-6">
        Sage is provided &quot;as is&quot; without any warranties. To the fullest extent permitted by law, we are not liable for any loss or damage arising from your use of the site. This includes, but is not limited to, any decisions you make based on information found on Sage or responses from the AI chatbot.
      </p>

      <h2 className="text-h2 font-bold mt-10 mb-4" style={{ color: "#2D5A3D" }}>External links</h2>
      <p className="text-body mb-6">
        Sage sometimes links to other websites. We do not control those sites and are not responsible for their content or privacy practices. We recommend checking their own terms and policies.
      </p>
